...
<head>
    ...
    <title>Dekor - Home version 2</title>
</head>
<body>
            ...
            <div class="row">
                <div class="col-lg-4 colg-md-4 col-sm-12 col-xs-12">
                    <div class="tz-about-item">
                        ...
                        <div class="tz-about-bk">
                            <img src="http://placehold.it/600x600" alt="Professional">
                ...
                <div class="col-lg-4 colg-md-4 col-sm-12 col-xs-12">
                    <div class="tz-about-item">
                        ...
                        <div class="tz-about-bk">
                            <img src="http://placehold.it/600x600" alt="Passionate">
                            <div class="tz-about-overlay">
                                <div class="tz-about-overlay-bk"></div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 colg-md-4 col-sm-12 col-xs-12">
                    <div class="tz-about-item">
                        ...
                        <div class="tz-about-bk">
                            <img src="http://placehold.it/600x600" alt="friendly">
                            <div class="tz-about-overlay">
                                <div class="tz-about-overlay-bk"></div>
                            </div>
                        </div>
    ...
    <section class="tz-why-choose theme-gray">
        <div class="tz-choose-content tz-choose-content2">
            <div class="container">
                <h3 class="tz-title-bold-3">
                    FEATURES
                </h3>
                <div class="row">
                    <div class="col-lg-4 colg-md-4 col-sm-4 col-xs-12">
                        <ul class="tz-collection collection-left tz-collection2">
                            <li>
                            ...
                            <li>
                                <figure class="item-collection">
                                    ...
                                    <figcaption>
                                        <h6>Clean Code</h6>
                                        <p>DEKOR has been built with the latest submission requirements based on the WordPres Codex.</p>
                                    </figcaption>
                                </figure>
                            </li>
                            <li>
                    ...
                    <div class="col-lg-4 colg-md-4 col-sm-4 col-xs-12">
                        <img class="collection-icon" src="http://placehold.it/430x505" alt="collection">
                    </div>
                    <div class="col-lg-4 colg-md-4 col-sm-4 col-xs-12">
                        <ul class="tz-collection tz-collection2">
                            <li>
                                <figure class="item-collection">
                                    <span class="tzcollection-icon tz-background1">
                                        <i class="fa fa-level-down"></i>
        ...
        </div><!--end class tz-choose-content-->
    ...
    <section class="tz-portfolio">
        ...
        <div class="tz-portfolio-content">
            <figure class="element tz-landscape">
                <img src="http://placehold.it/920x280" alt="Vivamus in lorem nisl">
                <figcaption>
            ...
            <figure class="element">
                <img src="http://placehold.it/540x280" alt="Aenean risus nisi">
                <figcaption>
            ...
            <figure class="element tz-portrait">
                <img src="http://placehold.it/420x560" alt="Quisque porttitor enim">
                <figcaption>
            ...
            <figure class="element tz-portrait">
                <img src="http://placehold.it/420x560" alt="Aenean fermentum interdum">
                <figcaption>
            ...
            <figure class="element">
                <img src="http://placehold.it/540x280" alt="Nam et aliquam eros">
                <figcaption>
            ...
            <figure class="element">
                <img src="http://placehold.it/540x280" alt="Praesent semper">
                <figcaption>
            ...
            <figure class="element">
                <img src="http://placehold.it/540x280" alt="Donec mauris ligula">
                <figcaption>
            ...
            <figure class="element">
                <img src="http://placehold.it/540x280" alt="Ut non ex viverra">
                <figcaption>
            ...
            <figure class="element">
                <img src="http://placehold.it/540x280" alt="Sed quis arcu luctus">
                <figcaption>
