...
<body>
    ...
    <section class="tzsingle-wrap">
        ...
        <div class="p-single-content">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-content-left">
                        <img src="http://placehold.it/570x370" class="alignnone" alt="single page float sidebar">
                        <br>
                        <img src="http://placehold.it/570x370" class="alignnone" alt="single page float sidebar">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-content-right">
