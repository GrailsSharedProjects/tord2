                    ...
                    <aside class="widget_bestsellers">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="as_bestsellers_content">
                                    <a href="#">Dress With Pastel Color</a>
                                    <span>$59.99</span>
                                </div>
                            </li>
                            <li>
                    ...
                    <div id="tz-shop-content" class="row">
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div id="slider" class="flexslider">
                                <ul class="slides">
                                    <li>
                                        <img src="http://placehold.it/370x370" alt="Roses Deco Accent Chair"/>
                                    </li>
                                    <li>
                                        <img src="http://placehold.it/370x370" alt="Roses Deco Accent Chair"/>
                                    </li>
                            ...
                            <div id="carousel">
                                <ul class="slides">
                                    <li>
                                        <img src="http://placehold.it/80x80" alt="Roses Deco Accent Chair" />
                                    </li>
                                    <li>
                                        <img src="http://placehold.it/80x80" alt="Roses Deco Accent Chair" />
                                    </li>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="tzshop-summary">
                                <h3>Roses Deco Accent Chair</h3>
                                <span class="tzproduct-single-price">
                                    $15.00 <small>$25.00</small> <a href="#">Reviews (2)</a>
                                </span>
                                ...
                                <ul class="tzshop-status">
                                    ...
                                    <li>
                                        <span>Product Code:</span> Product 7
                                    </li>
                                    <li>
                                ...
                                <div class="tzqty">
                                    Q.ty: <strong>1</strong>
                                </div>
                                 <span class="tz-shop-detail-meta">
                                    <a class="tzshopping" href="#">
